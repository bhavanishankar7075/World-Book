          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
            ...
            <div className="lg:col-span-1">
              <div className="flex items-center gap-3 mb-4">
                ...
                <span className="text-2xl font-bold">WorldBooks</span>
              </div>
              <p className="text-gray-400 text-sm leading-relaxed mb-6">
                Your premier destination for discovering and exploring millions of books online. Find bestsellers, classics, and hidden gems.
              </p>
              ...
              <div className="flex gap-3">
                <a
                  href="#"
                  className="bg-white bg-opacity-10 hover:bg-opacity-20 p-2.5 rounded-lg transition-all duration-300 hover:scale-110"
                  aria-label="Facebook"
                >
            ...
            <div>
              ...
              <p className="text-gray-400 text-sm mb-4 leading-relaxed">
                Subscribe to receive updates on new books, special offers, and exclusive deals.
              </p>
              <div className="space-y-3">
                <input
                  type="email"
                  placeholder="Enter your email"
                  className="w-full px-4 py-3 rounded-lg bg-white bg-opacity-10 border border-white border-opacity-20 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 text-white placeholder-gray-400 text-sm transition-all"
                />
                <button className="w-full bg-gradient-to-r from-blue-600 to-purple-600 text-white px-6 py-3 rounded-lg hover:shadow-lg transition-all duration-300 font-bold flex items-center justify-center gap-2">
        ...
        <div className="border-t border-gray-700 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-gray-400 text-sm text-center md:text-left">
              © {new Date().getFullYear()} <span className="font-semibold text-white">WorldBooks</span> Product Explorer. All rights reserved.
            </p>
